...
import HoldingsFundamentals from "../../../containers/dashboards/HoldingsFundamentals";
  ...
  render() {
    ...
    return (
      <Fragment>
        <Row>
          <Colxx xxs="12">
            <Breadcrumb heading="AM-30" match={this.props.match}/>
...
export default injectIntl(AM30Dashboard);