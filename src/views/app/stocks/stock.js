            ...
            <Row>
              <Colxx xxs="12">
                <Card className="h-100">
                  ...
                  <Row>
                    <Colxx xxs="12" sm="12" md="12" style={{paddingTop:'2rem', paddingRight:'2rem', paddingBottom:'0', paddingLeft:'2rem'}}>
                      <Table borderless>
                  ...
                  <Row>
                    <Colxx xxs="12" sm="12" md="12">
                      <CardTitle style={{display: 'flex', justifyContent: 'center', margin: 'auto'}}>
                        <h1 className='roboto-condensed' style={{fontSize:'20px', marginTop: '15px', marginBottom:'0', padding:'0'}}>About {quote.shortName}</h1>
                      </CardTitle>
